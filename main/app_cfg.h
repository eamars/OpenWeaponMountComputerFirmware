...
#define LOW_SLEEP_MODE_TASK_STACK 4096
#define LOW_SLEEP_MODE_TASK_PRIORITY 6

#define SENSOR_STABILITY_DETECTOR_POLLER_TASK_STACK 3072
#define SENSOR_STABILITY_DETECTOR_POLLER_TASK_PRIORITY 3
#define SENSOR_STABILITY_DETECTOR_REPORT_PERIOD_MS 10
